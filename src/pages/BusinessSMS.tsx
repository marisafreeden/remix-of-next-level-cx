...
const benefitIcons = [Clock, Route, MessageSquare];
const benefitKeys = ["b1", "b2", "b3"];
const featureKeys = ["f1", "f2", "f3"];
const useCaseKeys = ["uc1", "uc2", "uc3"];
const gridIcons = [Send, Clock, Route, Tag, Users, MessageSquare, Upload, Code];
...
const BusinessSMS = () => {
  ...
  return (
    <div style={{ background: "#ffffff", minHeight: "100vh" }}>
      ...
      <section className="uc-hero-section">
        <div className="uc-hero-inner">
          ...
          <div className="uc-hero-image">
            <img src={ucHeroImg} alt="Business SMS" />
          </div>
        </div>
      </section>
      ...
      <section className="uc-benefits-section">
        <div className="uc-benefits-header">
          ...
          <h2 className="promos-title">
            {t("sms_page.benefits_title1")}<br />
            <span className="promos-title-italic">{t("sms_page.benefits_title2")}</span>
          </h2>
        </div>
          ...
          {benefitKeys.map((key, i) => {
            ...
            return (
              <div key={key} className="uc-benefit-card">
                ...
                <h3 className="uc-benefit-title">{t(`sms_page.${key}_title`)}</h3>
                <p className="uc-benefit-desc">{t(`sms_page.${key}_desc`)}</p>
              </div>
            );
          })}
        </div>
      ...
      <section className="uc-features-section" style={{ paddingBottom: 0 }}>
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          <div className="uc-benefits-header" style={{ textAlign: 'center', marginBottom: '48px' }}>
            <p className="promos-eyebrow" style={{ textAlign: 'center' }}>{t("sms_page.platform_eyebrow")}</p>
            <h2 className="promos-title" style={{ textAlign: 'center' }}>
              {t("sms_page.platform_title1")}<br />
              <span className="promos-title-italic">{t("sms_page.platform_title2")}</span>
            </h2>
          </div>
          <div className="uc-big-feature-image">
            <img src={ucHeroImg} alt="Business SMS platform" />
          </div>
        </div>
      </section>
          ...
          {featureKeys.map((key, i) => (
            <div key={key} className={`promo-row ${i % 2 === 1 ? "promo-row-reverse" : ""}`}>
              <div className="promo-row-text">
                <h3 className="promo-row-title">{t(`sms_page.${key}_title`)}</h3>
                <p className="promo-row-desc" style={{ maxWidth: '520px' }}>{t(`sms_page.${key}_desc`)}</p>
              ...
              <div className="promo-row-image-wrap">
                <div className="uc-feature-placeholder">
                  <img src={ucHeroImg} alt={t(`sms_page.${key}_title`)} className="promo-row-image" />
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="uc-benefits-section">
        <div className="uc-benefits-header">
          <p className="promos-eyebrow">{t("sms_page.usecases_eyebrow")}</p>
          <h2 className="promos-title">
            {t("sms_page.usecases_title1")}<br />
            <span className="promos-title-italic">{t("sms_page.usecases_title2")}</span>
          </h2>
        </div>
        <div className="uc-benefits-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
          {useCaseKeys.map((key) => (
      ...
      <section className="uc-features-section">
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          <div className="uc-benefits-header" style={{ textAlign: 'center', marginBottom: '48px' }}>
            <p className="promos-eyebrow" style={{ textAlign: 'center' }}>{t("sms_page.integrations_eyebrow")}</p>
            <h2 className="promos-title" style={{ textAlign: 'center' }}>
              {t("sms_page.integrations_title1")}<br />
              <span className="promos-title-italic">{t("sms_page.integrations_title2")}</span>
            </h2>
            <p className="uc-hero-subtitle" style={{ textAlign: 'center', margin: '16px auto 0', maxWidth: '640px' }}>
              {t("sms_page.integrations_desc")}
            </p>
          </div>
          <div className="uc-integrations-image">
            <img src={integrationsImg} alt="Integration partners" />
          </div>
        </div>
      </section>
      ...
      <section className="uc-benefits-section">
        <div className="uc-benefits-header">
          <p className="promos-eyebrow">{t("sms_page.grid_eyebrow")}</p>
          <h2 className="promos-title">
            {t("sms_page.grid_title1")}<br />
            <span className="promos-title-italic">{t("sms_page.grid_title2")}</span>
          </h2>
        </div>
