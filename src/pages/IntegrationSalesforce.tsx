...
const steps = [
  "Agent logs in from inside Salesforce",
...
const included = [
  "Embedded call panel inside Salesforce",
...
const salesforceFaqs = [
  { q: "How does the Salesforce integration work?", a: "GoContact installs as an embedded panel inside Salesforce. Agents log in, select their queue or campaign, and handle inbound and outbound calls without leaving the CRM. Call outcomes and notes are saved to the contact record automatically." },
  { q: "Does this require custom development or professional services?", a: "No. GoContact connects to Salesforce through a managed package and can be deployed by your IT team. No custom integration work is needed." },
  { q: "What data is shared between GoContact and Salesforce?", a: "Call outcomes, interaction notes, and activity details are written to the contact record in Salesforce. Recordings remain in the GoContact platform." },
    ...
    <div className="intg-page">
      ...
      <section className="intg-hero">
        ...
        <div className="intg-hero-inner">
          <p className="promos-eyebrow" style={{ textAlign: "center" }}>SALESFORCE INTEGRATION</p>
          <h1 className="cc-hero-heading" style={{ fontSize: "56px", marginTop: "16px", marginBottom: "20px" }}>
            <span className="cc-hero-heading-line" style={{ paddingBottom: "2px" }}>Your agents are in Salesforce.</span>
          ...
          <p className="cc-hero-desc" style={{ maxWidth: "640px", margin: "0 auto 40px" }}>
            GoContact embeds directly inside Salesforce — so calls, outcomes, and customer records live in one place. No switching. No duplicate logging. No lost context.
          </p>
        ...
        <div className="intg-outcome-inner" style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div className="intg-outcome-text">
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "15px", fontWeight: 600, color: "#0a0f18", marginTop: "20px" }}>
              GoContact closes the gap — by bringing calls inside Salesforce.
            </p>
          </div>
          <PlaceholderImage />
        </div>
      ...
      <section className="uc-benefits-section">
        <div className="intg-outcome-inner" style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div className="intg-outcome-text">
            ...
            <p className="uc-benefit-desc" style={{ maxWidth: "480px" }}>
              GoContact installs as a native panel inside Salesforce. Agents pick their queue, handle calls, and never leave the CRM.
            </p>
      ...
      <section className="uc-benefits-section">
        <div className="uc-benefits-grid" style={{ maxWidth: "1200px" }}>
          {[
            { icon: Zap, title: "Less switching", desc: "Agents stay in Salesforce. No extra tools, no lost context, no reorienting mid-conversation." },
        ...
        <div className="intg-outcome-inner" style={{ maxWidth: "1200px", margin: "0 auto", gridTemplateColumns: "1.4fr 1fr" }}>
          <div className="intg-outcome-text">
            ...
            <p className="uc-benefit-desc" style={{ maxWidth: "520px" }}>
              No custom integration work. No professional services. GoContact connects to the Salesforce environment your team already uses — and your IT team already manages.
            </p>
          </div>
          <PlaceholderImage />
        </div>
      ...
      <section className="uc-benefits-section">
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          <h2 className="promos-title" style={{ textAlign: "center" }}>
            Your team lives in Salesforce.<br />
